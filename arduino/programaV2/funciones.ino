...
void modo(String first) {
  float motor1pos, motor2pos, motor1vel, motor2vel, motor1posActual, motor2posActual, motor2error, motor2velError;
  ...
  switch (modoFunc) {
    ...
    case 3:
      ...
      motor1pos = motor1pos * (-1); //Invertimos el valor del motor por estar en sentido contrario
      motor1.moveTo(motor1pos, motor1vel);
      motor2vel = fifth.toInt(); motor2pos = fourth.toInt();
      motor2.moveTo(motor2pos, motor2vel);
      ...
      //while (motor2error >= 0.1) {
        ...
        //}
      //}
      motor1pos = motor1lecturaEncoder(motor1posActual, motor1pos);
