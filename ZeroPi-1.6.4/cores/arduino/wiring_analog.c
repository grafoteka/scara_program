...
void analogWrite( uint32_t ulPin, uint32_t ulValue )
{
  ...
  if ( (attr & PIN_ATTR_PWM) == PIN_ATTR_PWM )
  {
    ...
    if ( TCx )
    {
      ...
      syncTC_8(TCx);
	  TCx->COUNT8.CTRLA.reg |= TC_CTRLA_PRESCALER_DIV16;  //setting prescaler to divide by 16
    ...
    else
    {
      ...
      syncTCC(TCCx);
      TCCx->CTRLA.reg |= TCC_CTRLA_PRESCALER_DIV16;  //setting prescaler to divide by 16
      // Set TCx as normal PWM
